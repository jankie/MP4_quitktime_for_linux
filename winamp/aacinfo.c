 ...
 *
 * $Id: aacinfo.c,v 1.22 2001/09/24 07:31:58 menno Exp $
 */
...
static int read_ADTS_header(FILE_STREAM *file, faadAACInfo *info, int *seek_table, int tagsize)
{
    ...
    for(frames=0; /* */; frames++)
    {
        ...
        pos = tell_filestream(file) - ADTS_MAX_SIZE;
