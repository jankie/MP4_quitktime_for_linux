...
public:
  ...
  virtual XmlManagedObjBase * xmlTestPath(const char * xmlpath, const char * xmltag);
  ...
  virtual void xmlSetData(const char * xmlpath, const char * xmltag, const char * data);
