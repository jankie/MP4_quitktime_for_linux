...
class ChunkInfos : public Dispatchable {
protected:
...
public:
  ...
  virtual void addInfo(const char *info, int value) { m_infolist.addItem(new ChunkInfo(info,value)); }
...
class Chunk : public Dispatchable {
protected:
...
class ChunkList : public Dispatchable {
protected:
