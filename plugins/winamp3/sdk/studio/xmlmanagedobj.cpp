...
//
XmlManagedObjBase * XmlManagedObjBase::xmlTestPath(const char * xmlpath, const char * xmltag) {
...
void XmlManagedObjBase::xmlSetData(const char * xmlpath, const char * xmltag, const char * xmldata) {
  data = xmldata;
}
